...
class TestTenant(TestCase):
    ...
    async def test1_get_tenant(self):
    ...
    async def test3_get_migration_center(self):
        result = await self.tenant.migration_center.get().execute_query()
    ...
    async def test9_create_site(self):
        pass
    ...
    async def test_13_get_all_tenant_themes(self):
        tenant = Office365Tenant(self.client)
        result = await tenant.get_all_tenant_themes().execute_query()
        self.assertIsNotNone(result)

    async def test_14_get_external_users(self):
        tenant = Office365Tenant(self.client)
        result = await tenant.get_external_users().execute_query()
        self.assertIsNotNone(result)

    async def test_15_get_tenant_cdn_enabled(self):
        tenant = Office365Tenant(self.client)
        result = await tenant.get_tenant_cdn_enabled(0).execute_query()
        self.assertIsInstance(result.value, bool)

    async def test_16_get_tenant_cdn_policies(self):
        tenant = Office365Tenant(self.client)
        result = await tenant.get_tenant_cdn_policies(0).execute_query()
        self.assertIsInstance(result.value, ClientValueCollection)

    async def test_17_get_tenant_settings_service(self):
        result = await self.tenant.admin_settings.get().execute_query()
        self.assertIsNotNone(result.resource_path)
    ...
    async def test_20_get_tenant_cdn_api(self):
        cdn_api = await self.tenant.cdn_api.get().execute_query()
    ...
    async def test_23_get_tenant_all_web_templates(self):
        result = await self.tenant.get_spo_tenant_all_web_templates().execute_query()
        self.assertIsNotNone(result.items)

    async def test_24_get_perf_data(self):
        from office365.sharepoint.migrationcenter.service.performance.data import (
            PerformanceData,
        )

        result = await PerformanceData(self.client).get().execute_query()
        self.assertIsNotNone(result.resource_path)

    async def test_25_get_power_apps_environments(self):
        result = await self.tenant.get_power_apps_environments().execute_query()
        self.assertIsNotNone(result.value)
    ...
    async def test_27_get_spo_all_web_templates(self):
        result = await self.tenant.get_spo_all_web_templates().execute_query()
        self.assertIsNotNone(result)
    ...
    async def test_29_get_app_service_principal(self):
    ...
    async def test_32_get_admin_endpoints(self):
        result = await self.tenant.admin_endpoints.get().execute_query()
        self.assertIsNotNone(result.resource_path)
    ...
    async def test_36_get_multi_geo_services(self):
        result = await self.tenant.multi_geo.storage_quotas.get().execute_query()
        self.assertIsNotNone(result.resource_path)

    async def test_37_get_site_subscription_id(self):
        result = await self.tenant.get_site_subscription_id().execute_query()
        self.assertIsNotNone(result.value)
    ...
    async def test38_get_comms_messages(self):
        result = await self.tenant.comms_messages.get().execute_query()
        self.assertIsNotNone(result.resource_path)
