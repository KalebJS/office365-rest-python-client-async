...
class TestField(SPTestCase):
    ...
    async def test_1_get_site_fields(self):
        site_fields = await self.client.site.root_web.fields.top(2).get().execute_query()
    ...
    async def test_3_get_field_by_title(self):
        title_field = await self.client.site.root_web.fields.get_by_title(self.target_field_name).get().execute_query()
    ...
    async def test_4_create_site_field(self):
        ...
        field = await self.client.site.root_web.fields.add_text_field(field_name).execute_query()
    ...
    async def test_5_update_site_field(self):
        ...
        updated_field = await self.client.site.root_web.fields.get_by_title(updated_field_name).get().execute_query()
